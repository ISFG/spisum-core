...
{
    public class FileDocumentRemoveValidator : AbstractValidator<FileDocumentRemove>
    {
        #region Fields
        ...
        public FileDocumentRemoveValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
