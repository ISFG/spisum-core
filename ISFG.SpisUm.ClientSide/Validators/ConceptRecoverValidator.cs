...
{
    public class ConceptRecoverValidator : AbstractValidator<ConceptRecover>
    {
        #region Fields
        ...
        public ConceptRecoverValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
        ...
        private bool CheckReasonLength(ConceptRecover node)
        {
