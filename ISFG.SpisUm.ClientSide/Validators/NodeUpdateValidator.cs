...
{
    public class NodeUpdateValidator : AbstractValidator<NodeUpdate>
    {
        #region Fields
        ...
        public NodeUpdateValidator(IAlfrescoHttpClient alfrescoHttpClient, INodesService nodesService, IIdentityUser identityUser, IDocumentService documentService)
        {
