...
{
    public class DocumentFoundValidator : AbstractValidator<DocumentFound>
    {
        #region Fields
        ...
        public DocumentFoundValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
