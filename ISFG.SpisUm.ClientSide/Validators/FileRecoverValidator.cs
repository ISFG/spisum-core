...
{
    public class FileRecoverValidator : AbstractValidator<FileRecover>
    {
        #region Fields
        ...
        public FileRecoverValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
        ...
        private bool CheckReasonLength(FileRecover node)
        {
