...
{
    public class ShipmentDispatchPublishValidator : AbstractValidator<ShipmentDispatchPublish>
    {
        #region Fields
        ...
        public ShipmentDispatchPublishValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
