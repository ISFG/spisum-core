...
{
    public class ShipmentFileCreatePostValidator : AbstractValidator<ShipmentFileCreatePost>
    {
        #region Fields
        ...
        public ShipmentFileCreatePostValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
        ...
        private bool CheckPostItemWeight(double? weight)
        {
