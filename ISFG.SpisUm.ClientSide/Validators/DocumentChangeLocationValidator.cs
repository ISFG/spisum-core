...
{
    public class DocumentChangeLocationValidator : AbstractValidator<DocumentChangeLocation>
    {
        #region Fields
        ...
        public DocumentChangeLocationValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
