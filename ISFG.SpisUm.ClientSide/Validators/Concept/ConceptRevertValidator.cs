...
{
    public class ConceptRevertValidator : AbstractValidator<ConceptRevert>
    {
        #region Fields
        ...
        public ConceptRevertValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
