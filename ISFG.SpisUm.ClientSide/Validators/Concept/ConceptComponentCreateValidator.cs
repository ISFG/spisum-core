...
{
    public class ConceptComponentCreateValidator : AbstractValidator<ConceptComponentCreate>
    {
        #region Fields
        ...
        public ConceptComponentCreateValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
