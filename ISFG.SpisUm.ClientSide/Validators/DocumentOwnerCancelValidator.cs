...
{
    public class DocumentOwnerCancelValidator : AbstractValidator<DocumentOwnerCancel>
    {
        #region Fields
        ...
        public DocumentOwnerCancelValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            ...
            RuleFor(o => o)
                ...
                .DependentRules(() =>
                {
                    ...
                    RuleFor(x => x.NodeId)
                        .Must(HasAction)
                        .WithMessage("NodeId has no cancel action.");
