...
{
    public class DocumentCancelValidator : AbstractValidator<DocumentCancel>
    {
        #region Fields
        ...
        public DocumentCancelValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
        ...
        private bool CheckReasonLength(DocumentCancel node)
        {
