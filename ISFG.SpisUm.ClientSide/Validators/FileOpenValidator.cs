...
{
    public class FileOpenValidator : AbstractValidator<FileOpen>
    {
        #region Fields
        ...
        public FileOpenValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
                ...
                .DependentRules(() =>
                {
                    ...
                    RuleFor(x => x.NodeId)
                        .Must(x => _nodeEntry.Entry.Path.Name.Equals(AlfrescoNames.Prefixes.Path + SpisumNames.Paths.EvidenceFilesClosed(identityUser.RequestGroup)))
                        .WithMessage($"NodeId must be in path {SpisumNames.Paths.EvidenceFilesClosed(identityUser.RequestGroup)}");
        ...
        private bool CheckReasonLength(FileOpen node)
        {
