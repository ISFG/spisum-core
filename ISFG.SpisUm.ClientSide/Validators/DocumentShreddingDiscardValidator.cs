...
{
    public class DocumentShreddingDiscardValidator : AbstractValidator<DocumentShreddingDiscard>
    {
        #region Fields
        ...
        public DocumentShreddingDiscardValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
