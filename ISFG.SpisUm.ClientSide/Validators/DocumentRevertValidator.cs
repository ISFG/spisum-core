...
{
    public class DocumentRevertValidator : AbstractValidator<DocumentRevert>
    {
        #region Fields
        ...
        public DocumentRevertValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
