...
{
    public class FileShreddingCancelDiscardValidator : AbstractValidator<FileShreddingCancelDiscard>
    {
        #region Fields
        ...
        public FileShreddingCancelDiscardValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
