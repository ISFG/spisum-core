...
{
    public class DocumentShreddingAValidator : AbstractValidator<DocumentShreddingA>
    {
        #region Fields
        ...
        public DocumentShreddingAValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
                ...
                { 
                    ...
                    RuleFor(x => x)
                        ...
                        .OnAnyFailure(x => throw new BadRequestException($"Document must be in {SpisumNames.Paths.RepositoryStored} or {SpisumNames.Paths.RepositoryRented} path."));      
