...
{
    public class FileFavouriteRemoveValidator : AbstractValidator<FileFavouriteRemove>
    {
        #region Fields
        ...
        public FileFavouriteRemoveValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
