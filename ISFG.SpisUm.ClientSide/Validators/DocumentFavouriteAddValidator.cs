...
{
    public class DocumentFavouriteAddValidator : AbstractValidator<DocumentFavouriteAdd>
    {
        #region Fields
        ...
        public DocumentFavouriteAddValidator(IAlfrescoHttpClient alfrescoHttpClient, IIdentityUser identityUser)
        {
            RuleFor(o => o)
