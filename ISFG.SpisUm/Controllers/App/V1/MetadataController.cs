    ...
    public class MetadataController : ControllerBase
    {
        ...
        private Dictionary<string, object> metadataMapper(NodeEntry nodeInfo)
        {
            ...
            return new Dictionary<string, object>
            {
                ...
                { "databoxAttachmentsCount", properties.TryGetValueFromProperties<string>(SpisumNames.Properties.DigitalDeliveryAttachmentsCount) },
                { "databoxNotRegisteredReason", properties.TryGetValueFromProperties<string>(SpisumNames.Properties.DigitalDeliveryNotRegisteredReasion) },
                ...
                { "emailAttachmentsCount", properties.TryGetValueFromProperties<string>(SpisumNames.Properties.DigitalDeliveryAttachmentsCount) },
                { "emailDeliveryDate", properties.TryGetValueFromProperties<string>(SpisumNames.Properties.DigitalDeliveryDeliveryDate) },
                { "emailNotRegisteredReason", properties.TryGetValueFromProperties<string>(SpisumNames.Properties.DigitalDeliveryNotRegisteredReasion) },
                { "emailSenderAddress", properties.TryGetValueFromProperties<string>(SpisumNames.Properties.EmailSender) },
                { "emailSubject", properties.TryGetValueFromProperties<string>(SpisumNames.Properties.DigitalDeliverySubject) },
                ...
                { "dmAnnotation", nodeEntry.NodeType == SpisumNames.NodeTypes.ShipmentDatabox ? properties.TryGetValueFromProperties<string>(SpisumNames.Properties.Subject) : properties.TryGetValueFromProperties<string>(SpisumNames.Properties.DigitalDeliverySubject) },
                { "dmDeliveryTime", nodeEntry.NodeType == SpisumNames.NodeTypes.ShipmentDatabox ? properties.TryGetValueFromProperties<string>(SpisumNames.Properties.DeliveryDate) : properties.TryGetValueFromProperties<string>(SpisumNames.Properties.DigitalDeliveryDeliveryDate) },
