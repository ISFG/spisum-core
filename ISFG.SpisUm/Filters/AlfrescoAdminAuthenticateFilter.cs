...
{
    public class AlfrescoAdminAuthenticateFilter : IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            if (context.HttpContext.User?.Identity?.IsAuthenticated == true && 
                context.HttpContext.User?.Identity?.AuthenticationType == AlfrescoIdentityTypes.AlfrescoAdminIdentity)
                return;
            if (context.HttpContext.User?.Identity?.IsAuthenticated == true)
